...
vim.keymap.set(
	...
	":<C-u>let g:ReplaceWithRegister_expr = getreg('=')<Bar>execute 'normal!' v:count1 . '.'<CR>",
	{ silent = true }
)
...
if vim.fn.hasmapto("<Plug>ReplaceWithRegisterLine", "n") == 0 then
	vim.keymap.set("n", "grr", "<Plug>ReplaceWithRegisterLine", { remap = true })
end
if vim.fn.hasmapto("<Plug>ReplaceWithRegisterVisual", "x") == 0 then
	vim.keymap.set("x", "gr", "<Plug>ReplaceWithRegisterVisual", { remap = true })
end
